# Ch08 > p.241 - Example 02
# Counting frequency of each letter (Level : HARD !)

import operator as op

org_text = '''내가 그의 이름을 불러주기 전에는 그는 다만 하나의 몸짓에 지나지 않았다.
...
if __name__ == "__main__" :
    ...
    countList = sorted(countDic.items(), key=op.itemgetter(1), reverse = True)
